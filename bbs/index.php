...
<a group="10" class="welive-new" style="cursor:pointer;padding: 4px 8px; border: 1px solid #c87713;background-color: #db8215;text-decoration:none;border-radius:4px;color:#fff;margin-left:50px;">进入10客服组</a>
<a group="11" class="welive-new" style="cursor:pointer;padding: 4px 8px; border: 1px solid #c87713;background-color: #db8215;text-decoration:none;border-radius:4px;color:#fff;margin-left:50px;">进入11客服组</a>
