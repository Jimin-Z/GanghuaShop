	...
	'group'=> array(
		...
		'options'=>array(
			'qq'=>array(
				...
				'options'=>array(
					'qq_tips'=>array(
						...
						<div style="color:red;">如果有多端使用QQ登录，则需要使用unionId机制,需要给腾讯客服发邮件开通，具体操作请查看《用户手册》</div>',
						'type'=>'hidden',
						'value'=>'',
						'tip'=>''
					),
			...
			'app_weixin'=>array(
				'title'=>'微信登录（App）',
				'options'=>array(
					'app_weixin_AppId'=>array(
						'title'=>'微信应用 AppID:',
						'type'=>'text',
						'value'=>'',
						'tip'=>''
					),
					'app_weixin_AppSecret'=>array(
						'title'=>'微信应用 AppSecret:',
						'type'=>'text',
						'value'=>'',
						'tip'=>''
					),
