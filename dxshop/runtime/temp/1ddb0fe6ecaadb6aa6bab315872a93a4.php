<?php /*a:5:{s:75:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\articles\news_list.html";i:1738761716;s:61:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\base.html";i:1738761714;s:60:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\top.html";i:1738761716;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\header.html";i:1738761715;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\footer.html";i:1738761714;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>
<?php echo $title; ?> - <?php echo WSTConf('CONF.mallName'); ?></title>

<meta name="keywords" content="资讯中心,<?php echo WSTConf('CONF.mallName'); ?>" />
<meta name="description" content="资讯中心,<?php echo WSTConf('CONF.mallName'); ?>" />
	...
	<div class="help-left">
		...
		<ul id="parent">
            ...
            <li class="h-cat h-show">
                <span><?php echo $v['catName']; ?><p></p></span>
                <ul class="h-list">
                    ...
                    <a href="<?php echo url('home/News/nList',['catId'=>$v1['catId']]); ?>"><li class="<?php if(($v1['catId']==$catId)): ?>h-curr<?php endif; ?>"><?php echo $v1['catName']; ?>（<?php echo $v1['newsCount']; ?>）</li></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<div class="help-right">
		<div class="h-content">
			...
			<ul class="news-list">
				...
				<li><div id="g-square"></div><a href="<?php echo url('home/news/view',['id'=>$li['articleId']]); ?>"><?php echo $li['articleTitle']; ?></a><span class="list-time"> <?php echo date('Y-m-d H:i:s',strtotime($li['createTime'])); ?></span></li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<?php endif; if(isset($newsList)): ?>
			<div class="head"><p><span>N</span>ews&nbsp;<?php echo $bc['catName']; ?></p><div class='wst-clear'></div></div>
			<ul class="news-list">
				...
				<li><div id="g-square"></div><a href="<?php echo url('home/news/view',['id'=>$n['articleId']]); ?>"><?php echo $n['articleTitle']; ?></a><span class="list-time"> <?php echo date('Y-m-d H:i:s',strtotime($n['createTime'])); ?></span></li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
