<?php /*a:5:{s:74:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\order_pay_step1.html";i:1569318612;s:63:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\base.html";i:1669564406;s:62:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\top.html";i:1738420029;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\header.html";i:1737808836;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\footer.html";i:1738136898;}*/ ?>
<!doctype html>
<head>
...
<div class="wst-container">
    ...
    <div class="pay-sbox-head">
    	<a href='<?php echo app('request')->root(true); ?>'>首页</a>&nbsp;&gt;&nbsp;支付
    </div>
    <div>
    ...
    <div class='pay-sbox'>
	    ...
	    <div class="tips-box">
	    	...
	    	请及时付款，以便快速处理您的订单，在线实付金额<span class="wst-fred">&nbsp;¥<?php echo $object['totalMoney']; ?>&nbsp;</span><span id="wst-check-orders" class="wst-check-orders">查看订单详情</span>
	    </div>
	    <div>
		    <div id="wst-orders-box" style="display:none;">
			    <table class='wst-order-list'>
				 	...
				 	<thead>
					 	<tr>
					     	<td colspan="3" class="wst-left-noborder wst-align-left">订单号：<?php echo $order['orderNo']; ?></td>
					        <td colspan="3" class="wst-right-noborder wst-align-right">订单金额：￥<?php echo $order['needPay']; ?>【运费：￥<?php echo $order['deliverMoney']; ?>】</td>
					 	</tr>
					 	<tr class='head'>
				   ...
				   <tbody class="otbody">
				 	...
				 	<tr>
				     	<td class="wst-left-noborder" width="64">
				     		<div class="goods-img">
					     		<a href="<?php echo url('home/goods/detail',array('goodsId'=>$vo['goodsId'])); ?>" target="_blank">
					     			<img class='goodsImg' data-original="__RESOURCE_PATH__/<?php echo $vo['goodsImg']; ?>"  title="<?php echo WSTStripTags($vo['goodsName']); ?>" width='60'/>
					     		</a>
				     		</div>
				     	</td>
				        <td class="wst-align-left">
				        	<div><?php echo $vo['goodsName']; if(count($vo['goodsSpecNames']) > 0): ?>
				        		【
				        ...
				        <td><?php echo $vo['goodsPrice']; ?></td>
				        <td><?php echo $vo['goodsNum']; ?></td>
				        <td class="wst-right-noborder"><?php echo $vo['goodsPrice']*$vo['goodsNum']; ?></td>
				 	</tr>
				 	<?php endforeach; endif; else: echo "" ;endif; ?>
				 	<?php endforeach; endif; else: echo "" ;endif; ?>
			       </tbody>
		    ...
		    <div class="pay-list">
		    	...
		    	<?php if(is_array($rs['payments']) || $rs['payments'] instanceof \think\Collection || $rs['payments'] instanceof \think\Paginator): $i = 0; $__LIST__ = $rs['payments'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$payment): $mod = ($i % 2 );++$i;if($payment['isOnline'] == 1): ?>
