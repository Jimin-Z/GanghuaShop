<?php /*a:4:{s:70:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\users\index.html";i:1670290018;s:69:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\users\base.html";i:1669879436;s:62:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\top.html";i:1738420029;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\footer.html";i:1738136898;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>会员中心 - <?php echo WSTConf('CONF.mallName'); ?></title>
...
<div>
                      <div class="u-base-info">
                          <div class="info-lcol">
                            ...
                            <div class="info-m">
                              <div class="u-name">
                                <a href="#" target="_blank"><?php echo session('WST_USER.userName')?session('WST_USER.userName'):session('WST_USER.loginName'); ?></a>
                              </div>
                              ...
                              <div class="u-level">
                                ...
                                <span class="rank r2">
                                  <span>
                                    <s><img class="rankimg" src="__RESOURCE_PATH__/<?php echo session('WST_USER.userrankImg'); ?>"/></s>
                                  </span>
                                <span><?php echo session('WST_USER.rankName'); ?></span>&nbsp;
                                </span>
                                <?php endif; ?>

                              </div>
                              <div class="u-safe">
                                  <a id="accountSafe" href="<?php echo url('home/users/security'); ?>"><span>账户安全：</span></a>
                                  <?php if(($level==1)): ?>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="count-item">
                                                <a href="<?php echo url('home/orders/waitPay'); ?>" target="_self">
                                                    <i class="count-icon count-icon01"></i> 待付款
                                                    <em id="waitPay"><?php echo $waitPay; ?></em>
                                                </a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="count-item">
                                                <a href="<?php echo url('home/orders/waitReceive'); ?>" target="_self">
                                                    <i class="count-icon count-icon02"></i> 待收货
                                                    <em id="waitReceive"><?php echo $waitReceive; ?></em>
                                                </a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="count-item">
                                                <a href="<?php echo url('home/orders/finish'); ?>" target="_self">
                                                  <i class="count-icon count-icon03"></i> 已收货
                                                    <em id="waitPick"><?php echo $received; ?></em>
                                                </a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="count-item">
                                                <a href="<?php echo url('home/orders/waitAppraise'); ?>">
                                                    <i class="count-icon count-icon04"></i> 待评价
                                                    <em id="waitAppr"><?php echo $waitAppr; ?></em>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="acco-item">
                                                <div>
                                                    <label>我的余额：</label>
                                                    <a href="<?php echo url('home/logmoneys/usermoneys?homeMenuId=43'); ?>" id="BalanceCount">￥<?php echo $data['userMoney']; ?></a>
                                                </div>
                                                <div>
                                                    <label>我的积分：</label>
                                                    <a href="<?php echo url('home/userscores/index?homeMenuId=43'); ?>" id="BalanceCount"><?php echo $data['userScore']; ?></a>
                                                </div>
                                                <div>
                                                    <label>未读消息：</label>
                                                    <a href="<?php echo url('home/messages/index'); ?>" id="BalanceCount"><?php echo $message; ?></a>
                                                </div>
                                                <div>
                                                    <label>上次登录：</label>
                                                    <a href="javascript:void(0)" id="BalanceCount"><?php echo session('WST_USER.lastTime'); ?></a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                ...
                <div class="mc">
                      <div id="tb-order" class="tb-order">
                          <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            <?php $wstTagOrder =  model("common/Tags")->listOrder("user",5,0,""); foreach($wstTagOrder as $key=>$vo){$hasOrder=true ?>
                            <tbody>
                              <tr>
                                <td>
                                  <div class="img-list">
                                    <?php if(is_array($vo['goods']) || $vo['goods'] instanceof \think\Collection || $vo['goods'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['goods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$og): $mod = ($i % 2 );++$i;?>
                                    <a href="<?php echo url('home/goods/detail',['goodsId'=>$og['goodsId']]); ?>" target="_blank">
                                      <img data-original='__RESOURCE_PATH__/<?php echo $og['goodsImg']; ?>'  class="goodsImg" />
                                    </a>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                  </div>
                                </td>
                                <td>
                                  <div class="u-name"><?php echo $vo['userName']; ?></div>
                                </td>
                                <td>￥<?php echo $vo['realTotalMoney']; ?><br><?php echo $vo['payType']==1 ? '在线支付' : '货到付款'; ?></td>
                                <td>
                                  <span class="ftx-03">
                                ...
                                <td class="td-01">
                                  <strong class="ftx-04 order-statu">
                                    <?php echo WSTLangOrderStatus($vo['orderStatus']); ?>
                                  </strong>
                                </td>
                                <td class="order-doi">
                                  <a target="_blank" href="<?php echo url('home/orders/detail',['id'=>$vo['orderId']]); ?>">【查看】</a>
                                </td>
                              </tr>
                            </tbody>
                            <?php } ?>
