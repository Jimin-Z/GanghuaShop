<?php /*a:4:{s:91:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\users\orders\list_order_appraise.html";i:1615362272;s:69:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\users\base.html";i:1669879436;s:62:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\top.html";i:1738420029;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\footer.html";i:1738136898;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>待评价订单 - 会员中心</title>
...
<div class="wst-wrap">
  ...
  <div class='wst-user-content'>
    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if((empty($vo['appraise']))): ?>
    <form id="appraise-form<?php echo $k; ?>">

    <div class="appraise-box">
      <input type="hidden" id="ogId<?php echo $k; ?>" value="<?php echo $vo['id']; ?>">
      <input type="hidden" id="gid<?php echo $k; ?>" value="<?php echo $vo['goodsId']; ?>">
      <input type="hidden" id="oid<?php echo $k; ?>" value="<?php echo $vo['orderId']; ?>">
      <input type="hidden" id="gsid<?php echo $k; ?>" value="<?php echo $vo['goodsSpecId']; ?>">
      <div class="o-goods-info">
        <img src="__RESOURCE_PATH__/<?php echo $vo['goodsImg']; ?>" title="商品名称"  />
        <p class="o-goodsName" title="<?php echo WSTStripTags($vo['goodsName']); ?>"><?php if($vo['goodsCode']=='gift'): ?>【赠品】<?php endif; ?><?php echo $vo['goodsName']; ?></p>
        <p class="o-goodsSpec" title="<?php echo WSTStripTags($vo['goodsSpecNames']); ?>"><?php echo $vo['goodsSpecNames']; ?></p>
      </div>
      <div class="appraise-area" id="app-box<?php echo $k; ?>">
                <div class="appraise-item goodsScore<?php echo $k; ?>">
                  <div class="appraise-title">商品评分：</div>
                  <div class="appraise-content">
                    <div class="<?php echo $vo['id']; ?>_goodsScore"  style='float:left'></div>
                    <div id="<?php echo $vo['id']; ?>_goodsScore_hint"  style='float:left'></div>
                  </div>
                </div>
                <div class="wst-clear"></div>

               <div class="appraise-item timeScore<?php echo $k; ?>">
                    <div class="appraise-title"> 时效评分：</div>
                    <div class="appraise-content">
                      <div class="<?php echo $vo['id']; ?>_timeScore"  style='float:left'></div>
                      <div id="<?php echo $vo['id']; ?>_timeScore_hint" style='float:left'></div>
                    </div>
               </div>
               <div class="wst-clear"></div>

               <div class="appraise-item serviceScore<?php echo $k; ?>">
                  <div class="appraise-title">服务评分：</div>
                  <div class="appraise-content">
                      <div class="<?php echo $vo['id']; ?>_serviceScore"  style='float:left'></div>
                      <div id="<?php echo $vo['id']; ?>_serviceScore_hint"  style='float:left'></div>
                  </div>
               </div>
               <div class="wst-clear"></div>
               <div id="score_error<?php echo $k; ?>"></div>

               <div class="appraise-item">
                  <div class="appraise-title">点评内容：</div>
                  <div class="appraise-content">
                      <textarea maxlength="200"  id="content<?php echo $k; ?>" style="width:610px;resize:none;" cols="70" rows="5"
               ...
               <div class="appraise-item">
                  ...
                  <div class="appraise-content">
                    ...
                    <div id='picBox<?php echo $k; ?>' style='height:120px;width:650px;margin-top:-20px;position:relative;'>
                    <div id="filePicker<?php echo $k; ?>" style='margin-left:0px;width:300px;position:relative;left:2px;top:23px;'>
                      晒照片(限5张)
                    </div>
    ...
    <div class="appraise-complate">
      ...
      <div class="appraise-area">
                <div class="appraise-item">
                  <div class="appraise-title">商品评分：</div>
                  <div class="appraise-content">
                    <?php $__FOR_START_7257__=0;$__FOR_END_7257__=$vo['appraise']['goodsScore'];for($i=$__FOR_START_7257__;$i < $__FOR_END_7257__;$i+=1){ ?>
                      <img src="/hkshopNC/dxshop/static/plugins/raty/img/star-on-big.png">
                    <?php } ?>
                  </div>
                </div>
                <div class="wst-clear"></div>
               ...
               <div class="appraise-item">
                    <div class="appraise-title"> 时效评分：</div>
                    <div class="appraise-content">
                       <?php $__FOR_START_2208__=0;$__FOR_END_2208__=$vo['appraise']['timeScore'];for($i=$__FOR_START_2208__;$i < $__FOR_END_2208__;$i+=1){ ?>
                        <img src="/hkshopNC/dxshop/static/plugins/raty/img/star-on-big.png">
                        <?php } ?>
                    </div>
               </div>
               ...
               <div class="appraise-item">
                  <div class="appraise-title">服务评分：</div>
                  <div class="appraise-content">
                      <?php $__FOR_START_28067__=0;$__FOR_END_28067__=$vo['appraise']['serviceScore'];for($i=$__FOR_START_28067__;$i < $__FOR_END_28067__;$i+=1){ ?>
                        <img src="/hkshopNC/dxshop/static/plugins/raty/img/star-on-big.png">
                      <?php } ?>
                  </div>
               </div>
               ...
               <div class="appraise-item">
                  <div class="appraise-title">点评内容：</div>
                  <div class="appraise-content">
                       <p class="complate-content"><?php echo $vo['appraise']['content']; ?>  [<?php echo date('Y-m-d',strtotime($vo['appraise']['createTime'])); ?>]</p>
                  </div>
               </div>
               <div class="wst-clear"></div>
               ...
               <div class="appraise-item">
                  <div class="appraise-title"> </div>
                  <div class="appraise-content">
                    <div id="appraise-img-<?php echo $k; ?>">
                    <?php if(is_array($vo['appraise']['images']) || $vo['appraise']['images'] instanceof \think\Collection || $vo['appraise']['images'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['appraise']['images'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;if(!empty($img)): ?>
                      <img src="__RESOURCE_PATH__/<?php echo str_replace('.','_thumb.',$img); ?>" layer-src="__RESOURCE_PATH__/<?php echo $img; ?>" width="75" height="75" />
                      <?php endif; ?>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                  </div>
...
<script type="text/javascript" src="/hkshopNC/dxshop/static/plugins/raty/jquery.raty.min.js?v=<?php echo $v; ?>"></script>
...
var options = {
      ...
      width:200,
      targetKeep: true,
      starHalf:'/hkshopNC/dxshop/static/plugins/raty/img/star-half-big.png',
      starOff:'/hkshopNC/dxshop/static/plugins/raty/img/star-off-big.png',
      starOn:'/hkshopNC/dxshop/static/plugins/raty/img/star-on-big.png',
      cancelOff: '/hkshopNC/dxshop/static/plugins/raty/img/cancel-off-big.png',
        cancelOn: '/hkshopNC/dxshop/static/plugins/raty/img/cancel-on-big.png'
    }
  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $key1 = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($key1 % 2 );++$key1;?>
    options.target='#<?php echo $g["id"]; ?>_goodsScore_hint';
    $('.<?php echo $g["id"]; ?>_goodsScore').raty(options);
    options.target='#<?php echo $g["id"]; ?>_timeScore_hint';
    $('.<?php echo $g["id"]; ?>_timeScore').raty(options);
    options.target='#<?php echo $g["id"]; ?>_serviceScore_hint';
    $('.<?php echo $g["id"]; ?>_serviceScore').raty(options);
    upload(<?php echo $key1; ?>);
    //调用验证规则
    validator(<?php echo $key1; ?>);
  <?php endforeach; endif; else: echo "" ;endif; ?>
});
