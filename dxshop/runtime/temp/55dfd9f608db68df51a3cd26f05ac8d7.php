<?php /*a:5:{s:71:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\forget_pass2.html";i:1612494640;s:63:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\base.html";i:1669564406;s:62:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\top.html";i:1738420029;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\header.html";i:1737808836;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\footer.html";i:1738136898;}*/ ?>
<!doctype html>
<head>
               ...
               <table class="wst-table">
                   <tbody>
				    ...
				    <tr class="wst-login-tr">
                         ...
                         <td colspan='2'><span class="wst-forget-te"><?php echo $forgetInfo['loginName']; ?></span></td>
                    </tr>
                 	  <tr class="phone-verify wst-login-tr">
                          <td class="wst-forget-td">手机</td>
                          <td colspan='2'><span class="wst-forget-te"><?php  echo $forgetInfo['userPhone'] == '' ? "没有预留手机号码，请尝试用邮箱找回！" : $forgetInfo['userPhone'] ;  ?></span></td>
                      </tr>
                      ...
                      <tr class="phone-verify wst-login-tr">
                          ...
                          <?php else: ?>
                          <?php echo hook('homeDocumentForgetSmsCaptcha'); ?>
                          <?php endif; ?>
	                ...
	                <tr class="phone-verify wst-login-tr">
                       ...
                       <tr class="email-verify wst-login-tr">
                           ...
                           <td colspan='2'><span class="wst-forget-te"><?php  echo $forgetInfo['userEmail'] == '' ? "没有预留邮箱，请尝试用手机号码找回！" : $forgetInfo['userEmail'] ;  ?></span></td>
                       </tr>
                    ...
                    <tr class="email-verify wst-login-tr">
          						...
          						<td>
          							...
          							<img id='verifyImg' class='wst-forget-codeim2' src="<?php echo url('home/users/getVerify'); ?>" onclick='javascript:WST.getVerify("#verifyImg","#verifyCode")'><span id="verifyCodeTips"></span>
          						   	</div>
        ...
        <tr>
			...
			<td>
				...
				<label style="float: left;">
					<img id='verifyImg2' src="<?php echo url('home/users/getVerify'); ?>" onclick='javascript:WST.getVerify("#verifyImg2","#smsVerfy")' style="width:115px;"> 
				</label>      	
