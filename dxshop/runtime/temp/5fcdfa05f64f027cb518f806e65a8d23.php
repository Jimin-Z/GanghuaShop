<?php /*a:5:{s:71:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\goods_contrast.html";i:1738761715;s:61:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\base.html";i:1738761714;s:60:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\top.html";i:1738761716;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\header.html";i:1738761715;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\footer.html";i:1738761714;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>商品对比 - <?php echo WSTConf('CONF.mallName'); ?></title>
...
<div class="wst-container">
	<div class="wst-contrast">
		<div class="goods" id="goodsTabs">
			<table class="table">
				<tbody><tr>
					...
					<?php if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$go): $mod = ($i % 2 );++$i;?>
					<td>
						<div class="goods-item">
							<div class="img"><a href="<?php echo Url('home/goods/detail','goodsId='.$go['goodsId']); ?>" target="_blank">
							<img class="goodsImg"  data-original="__RESOURCE_PATH__/<?php echo WSTImg($go['goodsImg']); ?>" title="<?php echo WSTStripTags($go['goodsName']); ?>">
							</a></div>
							<p class="name"><a href="<?php echo Url('home/goods/detail','goodsId='.$go['goodsId']); ?>" target="_blank"><?php echo $go['goodsName']; ?></a></p>
							<p class="price" id="goods-price-<?php echo $go['goodsId']; ?>">¥ <span><?php echo $go['shopPrice']; ?></span></p>
							<div class="operation">
								<a href="<?php echo Url('home/goods/detail','goodsId='.$go['goodsId']); ?>" target="_blank" class="see">查看</a>
								<?php if((count($data['list'])!=1)): ?><a href="javascript:void(0);" onclick="javascript:contrastDel(<?php echo $go['goodsId']; ?>)" class="del">删除</a><?php endif; ?>
							</div>
							<div class='wst-clear'></div>
						</div>
					</td>
		...
		<table class="table2">
		<tbody>
		<?php if(is_array($data['lists']) || $data['lists'] instanceof \think\Collection || $data['lists'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lis): $mod = ($i % 2 );++$i;?>
			<tr class="identical_<?php echo $lis['identical']; ?>">
				<th>
					<div class="left-title"><?php echo $lis['name']; ?></div>
				</th>
				<?php if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$go): $mod = ($i % 2 );++$i;$in = isset($lis['info'][$go['goodsId']])?$lis['info'][$go['goodsId']]:'--' ?>
				<td>
					<?php if(($lis['type']=='shop' || $lis['type']=='brand')): ?><div class="right-title"><?php echo $in; ?></div><?php endif; if(($lis['type']=='score')): ?>
						<div class="right-title">
						<?php $__FOR_START_1680459277__=0;$__FOR_END_1680459277__=$in;for($i=$__FOR_START_1680459277__;$i < $__FOR_END_1680459277__;$i+=1){ ?>
          					<img src="/qmdd/dxshop/static/plugins/raty/img/star-on.png">
          				<?php } $__FOR_START_965191379__=1;$__FOR_END_965191379__=6-$in;for($i=$__FOR_START_965191379__;$i < $__FOR_END_965191379__;$i+=1){ ?>
          					<img src="/qmdd/dxshop/static/plugins/raty/img/star-off.png">
          				<?php } ?>
						</div>
					<?php endif; if(($lis['type']=='spec')): if((isset($in['list']))): ?>
						<ul class="list-box">
							<?php if(is_array($in['list']) || $in['list'] instanceof \think\Collection || $in['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $in['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sp): $mod = ($i % 2 );++$i;if(($sp['isDefault']==1)): ?><input type="hidden" id="defaultSpec_<?php echo $go['goodsId']; ?>_<?php echo $sp['catId']; ?>" class="defaultSpec_<?php echo $go['goodsId']; ?>" value="<?php echo $sp['itemId']; ?>"/><?php endif; if(($sp['isAllowImg']==1)): ?>
								<li class="img <?php if(($sp['isDefault']==1)): ?>active<?php endif; ?>" onclick="javascript:choiceContrast(this,<?php echo $sp['itemId']; ?>,<?php echo $sp['catId']; ?>,<?php echo $go['goodsId']; ?>);">
									<img class="goodsImg" data-original="__RESOURCE_PATH__/<?php echo WSTImg($sp['itemImg']); ?>" title="<?php echo WSTStripTags($sp['itemName']); ?>">
								</li>
							<?php else: ?>
								<li class="<?php if(($sp['isDefault']==1)): ?>active<?php endif; ?>" onclick="javascript:choiceContrast(this,<?php echo $sp['itemId']; ?>,<?php echo $sp['catId']; ?>,<?php echo $go['goodsId']; ?>);"><?php echo $sp['itemName']; ?></li>
							<?php endif; ?>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
						<?php else: ?>
						<div class="right-title"><?php echo $in; ?></div>
						<?php endif; ?>
					<?php endif; ?>
				</td>
				<?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
var saleSpec = {
		<?php if(isset($data['saleSpec'])): ?>
		sku:<?php echo json_encode($data['saleSpec']); ?>
		<?php endif; ?>
	}
$(function(){
	fixedGoods();
