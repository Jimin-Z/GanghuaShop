<?php /*a:4:{s:83:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\users\orders\list_wait_pay.html";i:1738761722;s:67:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\users\base.html";i:1738761720;s:60:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\top.html";i:1738761716;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\footer.html";i:1738761714;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>待付款订单 - 会员中心</title>
<link rel="stylesheet" href="/qmdd/dxshop/static/plugins/layui/css/layui.css"/>
			...
			<div class="wst-shop-nav">
				<div class="wst-nav-box">
					<?php $homeMenus = WSTHomeMenus(0); if(is_array($homeMenus['menus']) || $homeMenus['menus'] instanceof \think\Collection || $homeMenus['menus'] instanceof \think\Paginator): $i = 0; $__LIST__ = $homeMenus['menus'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<a href="/qmdd/dxshop/<?php echo $vo['menuUrl']; ?>?homeMenuId=<?php echo $vo['menuId']; ?>"><li class="liselect wst-lfloat <?php if(($vo['menuId'] == $homeMenus['menuId1'])): ?>wst-nav-boxa<?php endif; ?>"><?php echo $vo['menuName']; ?></li></a>
       ...
       <tbody class="j-order-row">
         ...
         <tr class='goods-box'>
            ...
            <td class="wst-align-center" rowspan="{{rows}}">
                ...
                <div><a href='#none' onclick="view({{d[i].orderId}},'waitPay')">【订单详情】</a></div>
            </td>
            {{# } }}
         </tr>
         {{# } }}
