<?php /*a:5:{s:74:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\order_pay_step2.html";i:1592391806;s:63:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\base.html";i:1669564406;s:62:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\top.html";i:1738420029;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\header.html";i:1737808836;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\footer.html";i:1738136898;}*/ ?>
<!doctype html>
<head>
...
<div class="wst-container">
    ...
    <div class='pay-sbox' >
    	<div class="qrcode-box">
		    <div class="pbox">
	        	请您扫描以下二维码，支付订单总额：<span class="wst-fred">￥<?php echo $needPay; ?></span>
	        </div>
...
<script type='text/javascript' src='/hkshopNC/dxshop/static/js/qrcode.js?v=1<?php echo $v; ?>'></script>
<script>
	<?php if($out_trade_no != '' and $code_url!=''): ?>
	...
	setInterval(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.status==1){
					location.href = "<?php echo url('home/weixinpays/paySuccess'); ?>";
				}
			}
		});
	},1500);
