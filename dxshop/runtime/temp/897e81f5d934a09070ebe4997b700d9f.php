<?php /*a:5:{s:70:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\articles\help.html";i:1738761716;s:61:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\base.html";i:1738761714;s:60:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\top.html";i:1738761716;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\header.html";i:1738761715;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\footer.html";i:1738761714;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title><?php if($data['articleTitle']!=''): ?><?php echo $data['articleTitle']; else: ?>客服中心<?php endif; ?> - <?php echo WSTConf('CONF.mallName'); ?></title>

<meta name="keywords" content="<?php echo $data['articleKey']; ?>" />
<meta name="description" content="<?php echo $data['articleDesc']; ?>" />
...
<div class="bc-nav">
	<p>
		...
		<a href="#">> 客服中心</a>
		<?php if(is_array($bcNav) || $bcNav instanceof \think\Collection || $bcNav instanceof \think\Paginator): $i = 0; $__LIST__ = $bcNav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bc): $mod = ($i % 2 );++$i;if(($bc['catId']!=7)): ?>
	    <a href="<?php echo url('home/helpcenter/view',['id'=>$data['articleId']]); ?>">> <?php echo $bc['catName']; ?></a>
	    <?php endif; ?>
	    <?php endforeach; endif; else: echo "" ;endif; if(isset($data['articleTitle'])): ?>
	    	<a href="<?php echo url('home/helpcenter/view',['id'=>$data['articleId']]); ?>">> <?php echo $data['articleTitle']; ?></a>
	    <?php endif; ?>
	</p>
</div>
<div class="help-box">
	<div class="help-left">
		...
		<ul id="parent">
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;$cat=explode('-',$key);?>
            <li class="h-cat <?php if(($cat[1]==$data['catId'])): ?>h-show<?php else: ?>h-hide<?php endif; ?>">
                <span><?php echo $cat[0]; ?><p></p></span>
                <ul class="h-list">
                	<?php if(is_array($v) || $v instanceof \think\Collection || $v instanceof \think\Paginator): $k1 = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($k1 % 2 );++$k1;?>
                    <a href="<?php echo url('home/Helpcenter/view',['id'=>$v1['articleId']]); ?>"><li class="<?php if(($v1['articleId']==$data['articleId'])): ?>h-curr<?php endif; ?>"><?php echo WSTMSubstr($v1['articleTitle'],0,10); ?></li></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
	...
	<?php if(($data['articleTitle']!='')): ?>
	<div class="help-right b">
		<div class="h-right-title"><div id="square"></div><h4><?php echo $data['articleTitle']; ?></h4></div>
		<div class="c"><input type="hidden" value="<?php echo $data['articleId']; ?>" id="artId"></div>
		<div class="h-content">
			<?php echo htmlspecialchars_decode($data['articleContent']); ?>
		</div>
		<div class="c"></div>
		<div class="h-record">
			<p>以上内容是否已经解决您的问题呢？</p>
