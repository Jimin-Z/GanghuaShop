<?php /*a:5:{s:65:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\feedback.html";i:1738761714;s:61:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\base.html";i:1738761714;s:60:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\top.html";i:1738761716;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\header.html";i:1738761715;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\footer.html";i:1738761714;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>意见反馈 - <?php echo WSTConf('CONF.mallName'); ?></title>
...
<link href="__STYLE__/css/feedback.css?v=<?php echo $v; ?>" rel="stylesheet">
...
<div class='wst-user-content'>
    <form id="feedbackForm" method="post">
        <div class='wst-feedback-main'>
            <div class='wst-complain-order-head' style='width:1180px;'>意见反馈</div>
            <div class='wst-feedback-box'>
                <table>
                    <tr>
                        <td class="wst-feedback-box-tit">反馈类型<font color='red'>*</font>：</td>
                        <td>
                            ...
                            <label style="cursor:pointer;margin-right:10px;color: #666"><input type='radio' name='feedbackType' class='ipt' autocomplete="off" value='<?php echo $vo['dataVal']; ?>' <?php if($key==1): ?>checked<?php endif; ?>><?php echo $vo['dataName']; ?></label>
                            <?php endforeach; endif; else: echo "" ;endif; ?>

                        </td>
                    </tr>
                    <tr style="border-bottom: 0px;">
                        <td class="wst-feedback-box-tit">您的建议<font color='red'>*</font>：</td>
                        <td>
                            <textarea id='feedbackContent' name="feedbackContent" class='ipt' autocomplete="off" style='width:1030px;height:155px; resize: none;' placeholder='请输入您的宝贵建议'></textarea>
                        </td>
                    </tr>
                    <tr style="padding: 0px;">
                        <td class="wst-feedback-box-tit"></td>
                        <td>
                            <span id="feedbackContentMsg"></span>
                        </td>
                    </tr>
                    <tr style="border-bottom: 0px; padding-bottom: 0px;padding-top: 10px;">
                        <td  class="wst-feedback-box-tit">联系方式<font color='red'>*</font>：</td>
                        <td><input type='text' id='contactInfo' name='contactInfo' class='ipt' autocomplete="off" value='' placeholder='手机/QQ/微信' style='width:220px;'></td>
                    </tr>
                </table>
            </div>
        </div>
        <div class='wst-complain-footer'>
            <button onclick="javascript:save()" class="wst-sec-but u-btn">提交</button>
        </div>
    </form>
</div>
</div>
...
<script type="text/javascript" src="/qmdd/dxshop/static/plugins/validator/jquery.validator.min.js?v=<?php echo $v; ?>"></script>
<script type='text/javascript' src='__STYLE__/js/feedback.js?v=<?php echo $v; ?>'></script>
