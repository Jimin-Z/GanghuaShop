<?php /*a:4:{s:85:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\users\favorites\list_goods.html";i:1670220634;s:69:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\users\base.html";i:1669879436;s:62:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\top.html";i:1738420029;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\footer.html";i:1738136898;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>关注的商品 - 会员中心</title>
...
{{# for(var i = 0; i < d.length; i++){}}
	<div class="wst-fav-goods">
		<div class="wst-fav-goimg"><img class="goodsImg2" data-original="__RESOURCE_PATH__/{{ d[i].goodsImg }}" title="{{ d[i].goodsName }}"><span class="js-operate" onclick="javascript:cancelFavorite({{ d[i].favoriteId }},0)">取消收藏</div>
		<a href="javascript:getGoods({{ d[i].goodsId }})">
		<p class="wst-fav-gonam">{{WST.cutStr(d[i].goodsName,50)}}</p>
			<p class="wst-fav-goodp1"><span class="wst-fav-goodpr">￥{{ d[i].shopPrice }}</span><span class="wst-rfloat">成交数：<span class="wst-fav-goodpr2">{{ d[i].saleNum }}</span></span></p>
		...
		<div class="wst-clear"></div>
		<div class="wst-fav-price">
			{{# if(d[i].reducePrice>0){ }}
			<span>降</span>
			比关注时降价￥{{d[i].reducePrice}}
			{{# } }}
		</div>
		<p class="wst-fav-shop">
			<span class="wst-lfloat">{{WST.cutStr(d[i].shopName,8)}}</span>
			{{# for(var a = 0; a < d[i].accreds.length; a++){ }}
			<img src="__RESOURCE_PATH__/{{ d[i].accreds[a].accredImg }}" title="{{ d[i].accreds[a].accredName }}">
			{{# } }}
		</p>
		</a>
	</div>
