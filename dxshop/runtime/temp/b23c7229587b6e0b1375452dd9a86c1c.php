<?php /*a:2:{s:79:"D:\wamp\www\hkshopNC\dxshop\wstmart\shop\view\default\orders\list_finished.html";i:1738288113;s:63:"D:\wamp\www\hkshopNC\dxshop\wstmart\shop\view\default\base.html";i:1738111633;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wst-page">
  <div class='wst-toolbar'>
     ...
     <input type='hidden' id='userId' value='<?php echo $userId; ?>' class="s-ipt"/>
     <a class="btn btn-primary" onclick="finisedByPage()"><i class="fa fa-search"></i>查询</a>
     <?php if($userId >0): ?>
     <a class="btn btn-primary" style="float:right;" href='<?php echo url('shop/shopmembers/index'); ?>'><i class="fa fa-angle-double-left"></i>返回</a>
     <?php endif; ?>
     <a class="btn btn-primary" style="float:right;margin-right:10px" onclick="javascript:toExport(2,2,'')"><i class="fa fa-sign-out"></i>导出</a>
  </div>
  <div class='wst-grid'>
                      ...
                      <tr id='loading' class='empty-row' style='display:none'>
                       ...
                       <tbody class="j-order-row {{#if(d[i].isAppraise==0){}}j-warn{{#} }}">
                         ...
                         <div style="text-align:center;"><a href='#none' onclick="view({{d[i].orderId}},'finished')">【订单详情】</a></div>
                          <div style="text-align: center;"><a href='#none' onclick="remarks({{d[i].orderId}},'finished')">【备注订单】</a></div>
