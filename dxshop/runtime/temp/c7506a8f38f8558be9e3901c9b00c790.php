<?php /*a:1:{s:62:"D:\wamp64\www\hkshop\qmdd\dxshop\wstmart\admin\view\login.html";i:1738761698;}*/ ?>
<!DOCTYpE html>
<html>
<head>
...
<script type='text/javascript' src='/hkshop/qmdd/dxshop/static/js/jquery.min.js'></script>
<script>
window.conf = {"DOMAIN":"<?php echo str_replace('index.php','',app('request')->root(true)); ?>","ROOT":"/hkshop/qmdd/dxshop","APP":"/hkshop/qmdd/dxshop/index.php","STATIC":"/hkshop/qmdd/dxshop/static","SUFFIX":"<?php echo config('url_html_suffix'); ?>","IS_CRYPT":"<?php echo WSTConf('CONF.isCryptPwd'); ?>"}
</script>
<script type='text/javascript' src='/hkshop/qmdd/dxshop/static/js/common.js'></script>
