<?php /*a:5:{s:72:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\order_success.html";i:1566974140;s:63:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\base.html";i:1669564406;s:62:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\top.html";i:1738420029;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\header.html";i:1737808836;s:65:"D:\wamp\www\hkshopNC\dxshop\wstmart\home\view\default\footer.html";i:1738136898;}*/ ?>
<!doctype html>
<head>
    ...
    <div class='success-box'>
         ...
         <div class="info">
          <?php $len = count($object['list'])-1; ?>
              订单号：<?php if(is_array($object['list']) || $object['list'] instanceof \think\Collection || $object['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $object['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                   <a href='<?php echo url("home/orders/detail",array("id"=>$vo["orderId"])); ?>' target='_blank' onclick='WST.position(5,0)'><?php echo $vo['orderNo']; ?></a>
                   <?php if($i <= $len): ?>、<?php endif; ?>
                   <?php endforeach; endif; else: echo "" ;endif; ?>
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              应付金额：<span>¥<?php echo $object['totalMoney']; ?></span>
         </div>
         <div class="go">
         <a href='<?php echo url("home/index/index"); ?>' class="wst-order-success wst-cart-reda">继续购物</a>
         </div>
    </div>
</div>
