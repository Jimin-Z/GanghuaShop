<?php /*a:2:{s:75:"D:\wamp\www\hkshopNC\dxshop\wstmart\shop\view\default\goods\list_store.html";i:1669478144;s:63:"D:\wamp\www\hkshopNC\dxshop\wstmart\shop\view\default\base.html";i:1738111633;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wst-toolbar wst-toolbar2">
        <div class="s-menu">
            <button type="button" class="btn btn-primary" onclick="changeSale(1,'store')" >上架</button>
            <button type="button" class="btn btn-primary" onclick="changeGoodsStatus('isRecom','store')" >推荐</button>
            <button type="button" class="btn btn-primary" onclick="changeGoodsStatus('isNew','store')" >新品</button>
            <button type="button" class="btn btn-primary" onclick="changeGoodsStatus('isBest','store')" >精品</button>
            <button type="button" class="btn btn-primary mra" onclick="changeGoodsStatus('isHot','store')" >热销</button>
            <div class="flex1"></div>
            <button type="button" class="btn btn-primary" onclick="toAdd('store')">
              <span><i class="fa fa-plus"></i>新增</span>
            </button>
            <button type="button" class="btn btn-danger" onclick="benchDel('store')">
