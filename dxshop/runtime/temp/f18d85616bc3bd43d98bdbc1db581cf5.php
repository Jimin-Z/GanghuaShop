<?php /*a:5:{s:71:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\shop_join_step.html";i:1738761716;s:61:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\base.html";i:1738761714;s:60:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\top.html";i:1738761716;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\header.html";i:1738761715;s:63:"D:\wamp64\www\qmdd\dxshop\wstmart\home\view\default\footer.html";i:1738761714;}*/ ?>
<!doctype html>
<head>
    ...
    <?php elseif($flowId==4): if($pkey && $apply['applyStatus']==0): ?>
        ...
        <div class='apply-box'>
            <div class='examine-tips'>
                ...
                <img src='/qmdd/dxshop/wstmart/home/view/default/img/examine.png' style="vertical-align:middle"/>&nbsp;
                您的入驻申请已提交审核，请等待审核结果...
                <?php endif; if($apply['applyStatus']==-1): ?>
                <img src='/qmdd/dxshop/wstmart/home/view/default/img/error_1.png' style="vertical-align:middle"/>
                很抱歉，您的入驻申请因【<?php echo $apply['applyDesc']; ?>】审核不通过。。。
                <div style='clear:both;'></div>
                <?php endif; if($apply['applyStatus']==2): ?>
                <img src='/qmdd/dxshop/wstmart/home/view/default/img/apply-ok.png' style="vertical-align:middle"/>&nbsp;
                您的入驻申请已通过，赶紧开始上架商品吧~
                <?php endif; ?>
            </div>
        </div>
                                        ...
                                        <div id="<?php echo $vo['fieldName']; ?>ImgBox">
                                            ...
                                            <div style="width:75px;float:left;margin-right:5px;">
                                                ...
                                                <div style="position:relative;top:-80px;left:60px;cursor:pointer;background: rgba(0,0,0,0.5);width: 18px;height: 18px;text-align: center;border-radius: 50%;" onclick='javascript:delVO(this)' selector="<?php echo $vo['fieldName']; ?>">
                                                    <img src="/qmdd/dxshop/wstmart/home/view/default/img/seller_icon_error.png">
                                                </div>
                                            </div>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </div>
