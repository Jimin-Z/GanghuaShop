...
function(a, b) {
	...
	if (typeof WST.conf === "undefined" || typeof  WST.conf.sendmsg=== "undefined"){
	//console.log(WST.conf);	
       // WST.conf.sendmsg=0;
	}
	var url=a.url,sendcmd=0;//WST.conf.sendmsg;
   // if(url.includes('getSysMessages.html')&&(sendcmd==='1234') ){
      
   // }
   //console.log('line 3571==='+a.url);
