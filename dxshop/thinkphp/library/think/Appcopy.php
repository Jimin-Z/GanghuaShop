...
class App extends Container
{
 ...
 function put_msg($pmsg1='',$pmsg2='',$pmsg3='',$pmsg4=''){
     $this-> put_msging($pmsg1);
     if(!empty($pmsg2)) $this->put_msging($pmsg2);
     if(!empty($pmsg3)) $this-> put_msging($pmsg3);
     if(!empty($pmsg4)) $this->put_msging($pmsg4);
    }
