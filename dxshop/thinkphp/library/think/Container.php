...
class Container implements ArrayAccess, IteratorAggregate, Countable
{
  ...
  public static function put_error($str)
    {
        if (is_array($str))
 ...
 public static function put_msging($pmsg,$er=0){
        $s0=chr(13).chr(10);
        static::put_error($pmsg);   
         static::put_error(chr(13).chr(10));
        if(1==21){
...
public static  function put_msg($pmsg1='',$pmsg2='',$pmsg3='',$pmsg4=''){
     static::put_msging($pmsg1);
     if(!empty($pmsg2))  static::put_msging($pmsg2);
     if(!empty($pmsg3))  static:: put_msging($pmsg3);
     if(!empty($pmsg4))  static:: put_msging($pmsg4);
    }
