...
class Module extends Dispatch
{
    ...
    public function init()
    {
        ...
        if ($this->rule->getConfig('app_multi_module')) {
            ...
            //   throw new HttpException(404, 'module not exists:'.$this->app->getAppPath().'==' . $module);
            }
        }
    ...
    public function exec()
    {
        ...
        $this->app['middleware']->controller(function (Request $request, $next) use ($instance) {
            ...
            if (is_callable([$instance, $action])) {
                ...
                // 自动获取请求变量
                $vars = $this->rule->getConfig('url_param_type')  ? $this->request->route()
                : $this->request->param();
            ...
            if(indexof($action,'getSysMessages')>=0) {
                $d1=array("message"=>array("num"=>0,"id"=>49,"sid"=>120),
                "shoporder"=>array("24"=>0,"25"=>0,"55"=>25,"45"=>0,"54"=>230) ) ;
            }
       ...
       //    throw new HttpException(404, 'controller not exists:' . $this->rule->getConfig('url_controller_layer'));
     }
    }
}
