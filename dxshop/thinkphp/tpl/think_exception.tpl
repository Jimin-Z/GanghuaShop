...
<body>
    ...
    <div class="copyright">
        <span style='color:#777;'><a style='text-decoration:none;color:#777;' title="官方网站" href="http://hk-city.com">WSTMart</a> @ <a style='text-decoration:none;color:#777;' title="官方网站" href="http://qmdd.net">商淘云</a> - 专业电商系统及服务提供商</span> 
    </div>
    <?php if(\think\facade\App::isDebug()) { ?>
    <script>
