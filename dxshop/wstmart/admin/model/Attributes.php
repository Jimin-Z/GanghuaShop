...
class Attributes extends Base{
	...
	public function edit(){
        ...
        $oattr = Db::name("attributes")->where(['attrId'=>$attrId,'shopId'=>0])->find();
        //判断属性类型是否改变
	...
	public function listQuery(){
		...
		$rs = $this->field("attrId id, attrId, catId, attrName name,  '' goodsCatNames")->where(["dataFlag"=>1,"catId"=>$catId,"shopId"=>0])->sort('attrSort asc,attrId asc')->select();
		return $rs;
	}
}
