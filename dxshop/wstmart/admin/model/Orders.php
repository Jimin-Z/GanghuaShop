...
class Orders extends Base{
	...
	public function pageQuery($orderStatus = 10000,$isAppraise = -1){
		...
		if($shopId>0)$where[] = ['o.shopId','=',$shopId];
		...
		$page = $this->alias('o')->join('__USERS__ u','o.userId=u.userId','left')->join('__SHOPS__ s','o.shopId=s.shopId','left')->where($where)
		     ->field('o.orderId,o.orderNo,u.loginName,s.shopName,s.shopId,s.shopQQ,s.shopWangWang,o.goodsMoney,o.totalMoney,o.realTotalMoney,
		              o.orderStatus,o.userName,o.deliverType,payType,payFrom,o.orderStatus,orderSrc,o.createTime,o.orderCode,o.userAddress')
			 ->order($order)
	...
	public function toExport(){
		...
		->setCellValue('K1', '配送方式')->setCellValue('L1', '发票状态')->setCellValue('Z1', '用户留言')->setCellValue('M1', '发票信息')->setCellValue('N1', '订单商品')->setCellValue('O1', '商品价格')->setCellValue('P1', '数量')
