...
class TemplateMsgs extends Base{
	...
	public function getById($id){
		$rs = $this->get(['dataFlag'=>1,'id'=>$id]);
		$resourceDomain = WSTConf('CONF.resourcePath');
     	$rs['tplContent'] = str_replace('${DOMAIN}',$resourceDomain,$rs['tplContent']);
     	return $rs;
	}
    /**
	 * 编辑
	...
	public function edit(){
		...
		$resourceDomain = WSTConf('CONF.resourcePath');
		$data['tplContent'] = str_replace($resourceDomain.'/upload/','${DOMAIN}/upload/',$data['tplContent']);
