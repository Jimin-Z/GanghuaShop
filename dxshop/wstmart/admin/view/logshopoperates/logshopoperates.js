...
$(function(){
	...
	mmg = layui.table;
	mmg.render({elem: '#mmg',id:'dataTable',url:WST.U('admin/logshopoperates/pageQuery'),cellMinWidth: 80,height: WST.initGridHeight(),skin: 'line',even: true,limit:20,page:true,
		cols: [[
			{title:'#',type:'numbers'},
			{title:'帐号', field:'loginName',width:120},
			{title:'所属商家', field:'shopName',width:170},
			{title:'操作功能', field:'operateDesc' ,width:200},
