...
function initGrid(){
	mmg = layui.table;
	mmg.render({elem: '#mmg',id:'dataTable',url:WST.U('admin/payments/pageQuery'),cellMinWidth: 80,height: WST.initGridHeight(),skin: 'line',even: true,limit:20,page:true,
		cols: [[
			{title:'#',type:'numbers'},
			{title:'名称', field:'payName' ,width:120},
			{title:'描述', field:'payDesc' },
			{title:'状态', field:'enabled',width:150,templet: function(item){
				return (item['enabled']==1)?"<span class='statu-yes'><i class='fa fa-check-circle'></i> 开启</span>":"<span class='statu-no'><i class='fa fa-ban'></i> 关闭</span>";
			}},
			{title:'排序号', field:'payOrder',width:80},
