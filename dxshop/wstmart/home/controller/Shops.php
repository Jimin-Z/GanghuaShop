...
use wstmart\common\model\Trades;
...
class Shops extends Base{
    protected $beforeActionList = [
          'checkAuth'=>['only'=>'joinstepnext,checkusertype,savestep,checkapplystatus,checkstep']
    ];
