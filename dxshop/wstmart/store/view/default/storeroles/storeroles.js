...
function initGrid(p){
	mmg = layui.table;
	mmg.render({elem: '#mmg',id:'dataTable',url:WST.U('store/storeroles/pageQuery'),cellMinWidth: 80,height: WST.initGridHeight(),skin: 'line',even: true,limit:20,page:{curr:p},
		cols: [[
			{title:'#',type:'numbers'},
...
function loadGrid(p){
	p=(p<=1)?1:p;
	mmg.reload('dataTable',{where:{roleName:$('#roleName').val()},page:{curr:p}});
}
