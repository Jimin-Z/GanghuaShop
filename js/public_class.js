...
function index_job_new(allow_select_jobclass_count, target_jobclassin_names, target_jobclassin_ids, jobdiv_style, isShowBigClass)
{
    ...
    if (window.newjob_layer) {
        ...
        //  一级类目展开操作
        $(".pupopFristLeft li").on('click', function () {
        ...
        //  二级类目展开操作
        $(".secondTabLeft li").on('click', function () {
        ...
        //  一级类目选择操作
        $(".fristLeftp1 span").on('click', function (event) {
        ...
        //  二级类目选择操作
        $(".tabLeftName span").on('click', function (event) {
        ...
        //  删除已选操作
        $('.footerp2List p').on('click', function () {
