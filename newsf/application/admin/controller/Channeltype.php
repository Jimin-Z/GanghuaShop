                    ...
                    <div class="post">
                        <div class="md_block">
                            <div style=" color: #ff0000">
                                制作智讯通留言表单，主要有三个步骤：<br>1，后台>开启留言模型，建立栏目并选择留言模型。<br>2，打开根目录>template>{$tpl_theme}pc>lists_guestbook.htm模板文件，按照智讯通表单标签制作，<a href="http://www.hkshop.com/doc/label/arc/502.html" target="_blank">点击这里查看教程</a><br>3，还有疑问可以加智讯通交流群（群号：<a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=917f9a4cfe50fd94600c55eb75d9c6014a1842089b0479bc616fb79a1d85ae0b">704301718</a>）
                            </div>
                        </div>           
                    </div>
                </article>
