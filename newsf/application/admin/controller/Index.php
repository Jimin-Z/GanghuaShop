...
//        $this->assign('menu',getMenuList());
    ...
    public function welcome()
    {
        ...
        $viewfile = 'welcome';
        $f1='web_theme_welcome_tplname';
        $web_tplname = empty($this->globalConfig[$f1]) ? '' : $this->globalConfig[$f1];
        if (!empty($web_tplname) && file_exists("application/admin/template/theme/{$web_tplname}")) {
            $welcome_tplname = str_ireplace('.htm', '', $web_tplname);
