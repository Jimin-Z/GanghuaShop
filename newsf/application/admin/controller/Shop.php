...
<li class="">
    <div class="my">
        <div class="pic"><a href="https://www.hkshop.com/plus/view.php?aid={$val['id']}" target="_blank"><img src="{$val['litpic']}"></a></div>
        <span>
            <h2><a href="https://www.hkshop.com/plus/view.php?aid={$val['id']}" target="_blank">{$val['name']}</a></h2>
            <p>{$apply_channels}</p>
        </span>
        <div class="button">
            {$btn}
