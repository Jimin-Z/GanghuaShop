...
return array(
    'mysql' => [
        ...
        '2002:0'        => "连接数据库失败，请点击：<a href='http://www.hkshop.com/wenda/6236.html' target='_blank'>查看教程</a>",
        ...
        '42000:1055'    => "数据库sql_mode模式对GROUP BY聚合操作，请点击：<a href='http://www.hkshop.com/wenda/744.html' target='_blank'>查看教程</a>",
        ...
        'HY000:1615'    => "由于个别空间的数据库配置问题，请点击：<a href='https://www.hkshop.com/ask/?ct=question&askaid=3771' target='_blank'>查看教程</a>",
        'HY000:2000'    => "数据库配置不对，请查看配置文件 application/database.php 里信息是否正确。",
        'HY000:2002'    => "你的主机不支持 localhost 连接数据，导致报错，请点击：<a href='http://www.hkshop.com/wenda/5711.html' target='_blank'>查看教程</a>",
        'HY000:2013'    => "可能MySQL服务器不支持127.0.0.1连接，请点击：<a href='http://www.hkshop.com/wenda/5950.html' target='_blank'>查看教程</a>",
        'HY000:1290'    => "请重启MySql数据库，或者联系空间服务商处理。",
        'HY000:-1366'    => "可能编辑器里存在特殊表情、符号等导致，请点击：<a href='https://www.hkshop.com/plus/view.php?aid=28325' target='_blank'>查看教程</a>",
    ],
    'exception' => [
        '11602'        => "缓存写入失败，请点击：<a href='https://www.hkshop.com/ask/list_1_0/5507.html' target='_blank'>查看教程</a>",
    ],
    'wechat' => [
        '-1'    => '系统繁忙，此时请开发者稍候再试',
        '0'     => '请求成功',
