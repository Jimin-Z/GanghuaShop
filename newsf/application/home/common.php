    ...
    function set_typeseotitle($typename = '', $seo_title = '', $site_info = [])
    {
        ...
        if (empty($seo_title)) { // 针对没有自定义SEO标题的列表
            ...
            switch ($seo_liststitle_format) {
                case '1':  $seo_title = $old_typename.$seo_title_symbol.$web_name;
                    break;

                case '3':    $seo_title = $old_typename;
                    break;

                case '4':    $seo_title = $typename;       break;
