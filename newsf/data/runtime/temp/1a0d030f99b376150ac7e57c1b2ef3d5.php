...
<div class="page min-hg-c-10">
    <div class="flexigrid">
        <div class="mDiv">
            <div class="ftitle">
				<?php if($main_lang == $admin_lang || !empty($global['language_split'])): if(is_check_access(CONTROLLER_NAME.'@add') == '1'): ?>
        				 <div class="fbutton">
        ...
        <div class="hDiv">
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0" style="width: 100%">
                    <thead>
                        <tr>
                            <?php if($main_lang == $admin_lang || !empty($global['language_split'])): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($main_lang == $admin_lang): ?>
                                        <?php echo $vo['id']; else: ?>
                                        <?php echo (isset($main_adv_list[$vo['id']]['id']) && ($main_adv_list[$vo['id']]['id'] !== '')?$main_adv_list[$vo['id']]['id']:$vo['id']); endif; ?>
                                    </div>
                                </td>
                                ...
                                <td class="operation">
                                    <div class="w180 tc">
                                        ...
                                        <?php endif; if($main_lang == $admin_lang || !empty($global['language_split'])): if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                                        ...
                                        <a class="btn blue" href="javascript:void(0);" onclick="copyToClipBoard(<?php echo (isset($main_adv_list[$vo['id']]['id']) && ($main_adv_list[$vo['id']]['id'] !== '')?$main_adv_list[$vo['id']]['id']:$vo['id']); ?>, 1, <?php echo $vo['type']; ?>)">标签调用</a>
                                    </div>
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    function copyToClipBoard(id, limit, type) {
        ...
        contentdiv += '<dd><input type="text" style=" width:400px;" value="<script type=&quot;text/javascript&quot; src=&quot;http://' + '<?php echo \think\Request::instance()->server('http_host'); ?>' + '/hkshop/newsf/index.php?m=api&amp;c=Other&amp;a=other_show&amp;pid=' + id + '&amp;row='+limit+'&quot;><\/script>"></dd>';
