        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <br/>
                    <p class="notic2">开发模式：方便修改模板，及时预览前台效果，没缓存，一改便生效。<br/>运营模式：提高前台响应速度，利于收录；改模板及采集、导入文档等操作需执行【<a href="<?php echo U('System/clear_cache'); ?>">更新缓存</a>】后才能在前台展示。</p>
                </dd>
            </dl>
            <?php if($upgrade == 'true'): ?>
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <?php else: ?>
                        <label class="curpoin" title="不再收到系统更新提醒" onclick="showErrorAlert('仅限于授权域名使用', 4);"><input type="radio" name="web_show_popup_upgrade" value="2" <?php if(isset($config['web_show_popup_upgrade']) && $config['web_show_popup_upgrade'] == 2): ?>checked="checked"<?php endif; ?> disabled="disabled">完全关闭</label>
                    <?php endif; ?>
                    &nbsp;
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <label class="curpoin"><input type="radio" name="web_recycle_switch" value="0" <?php if(empty($config['web_recycle_switch'])): ?>checked="checked"<?php endif; ?>>开启</label>
                    &nbsp;
                    <label class="curpoin"><input type="radio" name="web_recycle_switch" value="1" <?php if(!empty($config['web_recycle_switch'])): ?>checked="checked"<?php endif; ?>>关闭</label>
