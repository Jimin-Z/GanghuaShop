<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./application/admin/template/arctype\index.htm";i:1718265302;s:82:"D:\wampserver\wamp64\www\hkshop\newsf\application\admin\template\public\layout.htm";i:1711350610;s:85:"D:\wampserver\wamp64\www\hkshop\newsf\application\admin\template\public\theme_css.htm";i:1718265303;s:82:"D:\wampserver\wamp64\www\hkshop\newsf\application\admin\template\public\footer.htm";i:1680168736;}*/ ?>
<!doctype html>
<html>
<head>
                        ...
                        <tr>
                            ...
                            <th axis="col3" class="">
                                <div class="sundefined text-l10">
                                    ...
                                    <img src="/hkshop/newsf/public/static/admin/images/tv-collapsable-last.gif" id="all_treeclicked" title="关闭所有子栏目" style="float: none;" data-status="open" onClick="treeClicked(this,'all',0);">
                                    <?php else: ?>
                                    <img src="/hkshop/newsf/public/static/admin/images/tv-expandable.gif" id="all_treeclicked" title="展开所有子栏目" style="float: none;" data-status="close" onClick="treeClicked(this,'all',0);">
                                    <?php endif; ?>
                                栏目名称
                                </div>
                            </th>
                        ...
                        <td class="typename" style="width: 100%">
                            ...
                            <?php if($vo['level'] > '0'): 
                              if (1 == $vo['level']) {
                                ...
                                <img src="<?php if(in_array(($vo['id']), is_array($tree['cookied_treeclicked'])?$tree['cookied_treeclicked']:explode(',',$tree['cookied_treeclicked']))): ?>/hkshop/newsf/public/static/admin/images/tv-collapsable-last.gif<?php else: ?>/hkshop/newsf/public/static/admin/images/tv-expandable.gif<?php endif; ?>" style="float: none;" fieldid="2" status="open" nc_type="flex" onClick="treeClicked(this,<?php echo $vo['id']; ?>,0);" class="has_children"  data-level="<?php echo $vo['level']; ?>" data-id="<?php echo $vo['id']; ?>">
                            <?php else: ?>
                                <img src="/hkshop/newsf/public/static/admin/images/tv-collapsable-last.gif" style="float: none;" fieldid="2" status="open" nc_type="flex">
    ...
    function treeClicked(obj,id,reload){
        if (id == 'all') {
          ...
          if (status == 'close') {
            ...
            $('tr[class^=parent_id_]').show().find('img').attr('src', '/hkshop/newsf/public/static/admin/images/tv-collapsable-last.gif');
            $(obj).attr('data-status', 'open').attr('title','关闭所有子栏目').attr('src','/hkshop/newsf/public/static/admin/images/tv-collapsable-last.gif');
          } else {
            ...
            $(obj).attr('data-status', 'close').attr('title','展开所有子栏目').attr('src','/hkshop/newsf/public/static/admin/images/tv-expandable.gif');
          }
         ...
         if(src == '/hkshop/newsf/public/static/admin/images/tv-expandable.gif')
         {
             ...
             $(".parent_id_"+id).show();
             $(obj).attr('src','/hkshop/newsf/public/static/admin/images/tv-collapsable-last.gif');
             var status = 'close';
         }else{
             var str = getCookie('admin-treeClicked-Arr');
             ...
             $(obj).attr('src','/hkshop/newsf/public/static/admin/images/tv-expandable.gif');     
             var status = 'open';      
              ...
              for (var i = 0; i < tbl.rows.length; i++)
              {
                  ...
                  else
                  {
                      if (fnd == true)
                      {
                          ...
                          {
                              $(row).hide();        
                              $(row).find('img.has_children').attr('src','/hkshop/newsf/public/static/admin/images/tv-expandable.gif');
                          }
                          else
                          {
                              fnd = false;
