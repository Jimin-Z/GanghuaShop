<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"./application/admin/template/seo\seo.htm";i:1723952802;s:69:"D:\wamp\www\hkshop\newsf\application\admin\template\public\layout.htm";i:1711350610;s:72:"D:\wamp\www\hkshop\newsf\application\admin\template\public\theme_css.htm";i:1718265302;s:63:"D:\wamp\www\hkshop\newsf\application\admin\template\seo\bar.htm";i:1655708908;s:69:"D:\wamp\www\hkshop\newsf\application\admin\template\public\footer.htm";i:1680168736;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo url('Seo/handle'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            ...
            <dl class="row <?php if(empty($config['seo_pseudo']) || 1 != $config['seo_pseudo'] || (1 == $config['seo_pseudo'] && 1 == $config['seo_dynamic_format'])): ?>none<?php endif; ?>" id="dl_seo_dynamic_format">
                ...
                <dd class="opt">
                    <label class="curpoin"><input type="radio" name="seo_dynamic_format" value="1" <?php if(!isset($config['seo_dynamic_format']) OR $config['seo_dynamic_format'] == 1): ?>checked="checked"<?php endif; ?>>完全兼容（<a href="javascript:void(0);" onclick="view_exp('view_1_1');">查看例子</a><span id="view_1_1" class="none">：https://qmdd.net/hkshop/newsf/index.php?m=home&amp;c=Lists&amp;a=index&amp;tid=1</span>）</label>&nbsp;
                    <?php if(isset($config['seo_dynamic_format']) AND $config['seo_dynamic_format'] == 2): ?>
                    <br/>
                    <label class="curpoin"><input type="radio" name="seo_dynamic_format" value="2" checked="checked">部分兼容&nbsp;<font color="red">[部分空间不支持]</font>（<a href="javascript:void(0);" onclick="view_exp('view_1_2');">查看例子</a><span id="view_1_2" class="none">：https://qmdd.net/hkshop/newsf/home/Lists/index.html?tid=1</span>）</label>&nbsp;
                    <?php endif; ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
    ...
    $(function(){
        ...
        $('input[name="seo_force_inlet"]').click(function(){
            if (1 == $(this).val()) {
                layer.open({
                    ...
                    closeBtn: 0,
                    shadeClose: true,
                    content: '//<?php echo $website_host; ?>/hkshop/newsf/api/Rewrite/testing.html',
                    success: function(layero, index){
                        ...
                        if (content.indexOf("Congratulations on passing") == -1)
                        {
                            ...
                            layer.alert('不支持去除index.php，请<a href="javascript:void(0);" onclick="layer.closeAll();click_to_eyou_1575506523(\'https://www.hkshop.com/plus/view.php?aid=7874&origin_eycms=1\',\'去掉URL中的index.php教程\');">点击查看教程</a>', {icon: 2, title:false});
                        }
                    }
                });
            }
        ...
        function checkInlet() {
            ...
            layer.open({
                ...
                closeBtn: 0,
                shadeClose: true,
                content: '//<?php echo $website_host; ?>/hkshop/newsf/api/Rewrite/setInlet.html',
                success: function(layero, index){
                    layer.close(index);
                    var body = layer.getChildFrame('body', index);
                    var content = body.html();
                    if (content.indexOf("Congratulations on passing") == -1)
                    {
                        ...
                        $.ajax({
                            type : "POST",
                            url  : "/hkshop/newsf/index.php?m=api&c=Rewrite&a=setInlet",
