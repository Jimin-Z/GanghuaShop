<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/template/index\switch_map.htm";i:1723952802;s:72:"D:\wamp\www\hkshop\newsf\application\admin\template\public\theme_css.htm";i:1718265302;}*/ ?>
<!doctype html>
<html>
<head>
...
<link rel="stylesheet" href="/hkshop/newsf/public/static/admin/css/welcome.css?v=<?php echo $version; ?>" type="text/css">   <!--界面修改新添样式 -->
...
<script type="text/javascript" src="/hkshop/newsf/public/static/common/js/jquery.min.js?v=<?php echo $version; ?>"></script>
             ...
             <div class="on-off_list_bg bg-fff" id="wendangxiagnguan" style="display: block;">
                 ...
                 <div class="on-off_list" id="wendangxiagnguan_child" style="display: block;">
                     <ul class="flex-dir-row  flex-wrap">
                         ...
                         <?php endif; if(is_check_access('Archives@index_draft') == '1'): if($main_lang == $admin_lang): ?>
                             <li class="more_li" id="li_1004" <?php if(in_array('1004',$admin_menu_id_arr) || in_array('1004',$not_role_menu_id_arr)): ?>style="display:none"<?php endif; ?>>
                                 <div class="flex-dir-row flex-a-center">
                                     ...
                                     <div class="ml-8">
                                         <a href="javascript:void(0);" data-href="<?php echo url('Archives/index_draft'); ?>"  onclick="gourl2(this,1);">待审文档</a>
                                     </div>
                                 </div>
                                <?php if(!(empty($is_founder) || (($is_founder instanceof \think\Collection || $is_founder instanceof \think\Paginator ) && $is_founder->isEmpty()))): ?>
                                 <div class="icon-link_add">
                         ...
                         <!-- <?php if(is_check_access('Archives@index_reback') == '1'): if($main_lang == $admin_lang): ?>
                             <li class="more_li" id="li_1006" <?php if(in_array('1006',$admin_menu_id_arr) || in_array('1006',$not_role_menu_id_arr)): ?>style="display:none"<?php endif; ?>>
                                 <div class="flex-dir-row flex-a-center">
                                     <div class="icon_bg icon_bg_no">
                                         <i class="iconfont  e-tougao f-20 col-848484" ></i>
                                     </div>
                                     <div class="ml-8">
                                         <a href="javascript:void(0);" data-href="<?php echo url('Archives/index_reback'); ?>"  onclick="gourl2(this,1);">退回文档</a>
                                     </div>
                                 </div>
                                <?php if(!(empty($is_founder) || (($is_founder instanceof \think\Collection || $is_founder instanceof \think\Paginator ) && $is_founder->isEmpty()))): ?>
                                    <div class="icon-link_add">
                         ...
                         <?php if(is_check_access('AdPosition@index') == '1'): ?>
                 ...
                 <div class="on-off_list" id="gaojixuanxiang_child" style="display: block;">
                     <ul class="flex-dir-row  flex-wrap">
                         ...
                         <?php endif; if(is_check_access('Admin@admin_pwd') == '1'): if($main_lang == $admin_lang): ?>
                             ...
                             <?php endif; endif; if(is_check_access('RecycleBin@arctype_index') == '1'): if($main_lang == $admin_lang || !empty($global['language_split'])): if($global['web_recycle_switch'] != '1'): ?>
                            ...
                            <?php endif; endif; if(is_check_access('Security@index') == '1'): if($main_lang == $admin_lang): ?>
                             ...
                             <?php endif; endif; if(in_array('memgift', $useFunc) && $php_servicemeal > 1 && !empty($userConfig['memgift_open']) && $main_lang == $admin_lang): if(is_check_access('Memgift@gift_exchange_list') == '1'): ?>
                            <li class="more_li" id="li_2004023" <?php if(in_array('2004023',$admin_menu_id_arr) || in_array('2004023',$not_role_menu_id_arr)): ?>style="display:none"<?php endif; ?>>
                                <div class="flex-dir-row flex-a-center">
                                    ...
                                    <div class="ml-8 white-space">
                                        <a href="javascript:void(0);" data-href="<?php echo url('Memgift/gift_exchange_list'); ?>"  onclick="gourl2(this,1);">积分兑换</a>
                                    </div>
                                </div>
                                <?php if(!(empty($is_founder) || (($is_founder instanceof \think\Collection || $is_founder instanceof \think\Paginator ) && $is_founder->isEmpty()))): ?>
                                <div class="icon-link_add">
                        ...
                        <?php endif; if(is_check_access('Index@theme_index') == '1'): if($main_lang == $admin_lang): ?>
                            <li class="more_li" id="li_2004025" <?php if(in_array('2004025',$admin_menu_id_arr) || in_array('2004025',$not_role_menu_id_arr)): ?>style="display:none"<?php endif; ?>>
                                <div class="flex-dir-row flex-a-center">
                                    <div class="icon_bg icon_bg_no">
                                        <i class="iconfont f-20 e-zhutifengge col-848484" ></i>
                                    </div>
                                    <div class="ml-8 white-space">
                                        <a href="javascript:void(0);" data-href="<?php echo url('Index/theme_index'); ?>"  onclick="gourl2(this,1);">主题风格</a>
                                    </div>
                                </div>
                                <?php if(!(empty($is_founder) || (($is_founder instanceof \think\Collection || $is_founder instanceof \think\Paginator ) && $is_founder->isEmpty()))): ?>
                                <div class="icon-link_add">
                             ...
                             <?php endif; endif; if(is_check_access('Foreign@index') == '1'): if(($php_servicemeal >= 1 || $foreign_authorize == 1) && $main_lang == $admin_lang): ?>
                            <li class="more_li" id="li_2004026" <?php if(in_array('2004026',$admin_menu_id_arr) || in_array('2004026',$not_role_menu_id_arr)): ?>style="display:none"<?php endif; ?>>
                                <div class="flex-dir-row flex-a-center">
                                    <div class="icon_bg icon_bg_no">
                                        <i class="iconfont f-20 e-waimaoshezhi col-848484" ></i>
                                    </div>
                                    <div class="ml-8 white-space">
                                        <a href="javascript:void(0);" data-href="<?php echo url('Foreign/index'); ?>"  onclick="gourl2(this,1);">外贸助手</a>
                                    </div>
                                </div>
                                <?php if(!(empty($is_founder) || (($is_founder instanceof \think\Collection || $is_founder instanceof \think\Paginator ) && $is_founder->isEmpty()))): ?>
                                <div class="icon-link_add">
                                    <div title="加入导航显示" data-menu_id="2004026" class="iconfont e-jiahao2"></div>
                                </div>
                                <?php endif; ?>
                            </li>
                            <?php endif; endif; ?>
            ...
            <div class="on-off_list_bg bg-fff" id="shangchengmokuai" style="display: block;">
                ...
                <div class="on-off_list" id="shangchengmokuai_child" style="display: block;">
                    <ul class="flex-dir-row  flex-wrap">
                        ...
                        <?php endif; if(true || !empty($marketFunc)): if(is_check_access('Shop@market_index') == '1'): ?>
                    ...
                    if(res.code == 1){
                        ...
                        if (1 == res.data.code) {
                            ...
                            _parent.layer.alert(res.msg, {btn: ['购买授权'], icon: 4, title:false}, function(){
                                _parent.layer.closeAll();
                                window.location.reload();
                                window.open('https://www.hkshop.com/buy');
                            });
                        } else {
