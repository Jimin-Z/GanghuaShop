<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/template/archives\index.htm";i:1711350550;s:72:"D:\wamp\www\hkshop\newsf\application\admin\template\public\theme_css.htm";i:1718265302;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <!-- <link rel="stylesheet" href="/hkshop/newsf/public/plugins/ztree/css/amazeui.min.css"> -->
    <link rel="stylesheet" href="/hkshop/newsf/public/plugins/ztree/css/iframe.css?v=<?php echo $version; ?>">
    <link rel="stylesheet" href="/hkshop/newsf/public/plugins/ztree/css/zTreeStyle/zTreeStyle.css?v=<?php echo $version; ?>" type="text/css">
    <link href="/hkshop/newsf/public/static/admin/font/css/font-awesome.min.css" rel="stylesheet" />
    <link href="/hkshop/newsf/public/static/admin/css/left_nav_tree.css?v=<?php echo $version; ?>" rel="stylesheet" type="text/css">
    <style type="text/css">
        ...
        .title-cate{padding:8px 0 8px 28px;border-bottom: 1px solid #eee;color: #999;font-size: 15px;height: 24px;line-height: 24px; background: url("/hkshop/newsf/public/plugins/ztree/css/zTreeStyle/img/titleIcon.png") no-repeat 10px center;background-size: 15px 15px;}
        ...
        .allshow i{width: 18px; height: 18px;display: inline-block;background-image: url("/hkshop/newsf/public/plugins/ztree/css/zTreeStyle/img/zTreeStandard.png");vertical-align: middle;}
   ...
   .flexigrid .mDiv .ftitle h3 {border-left: 3px solid <?php echo $global['web_theme_color']; ?>;} 
    ...
    <script src="/hkshop/newsf/public/static/admin/js/jquery.layout-latest.min.js"></script>
    <script type="text/javascript" src="/hkshop/newsf/public/plugins/ztree/js/jquery.ztree.core.min.js"></script>
    <script type="text/javascript" src="/hkshop/newsf/public/plugins/layer-v3.1.0/layer.js"></script>
    <script src="/hkshop/newsf/public/static/admin/js/global.js?v=<?php echo $version; ?>"></script>
    <!--[if lt IE 9]>
    <script src="/hkshop/newsf/public/static/admin/js/html5shiv.js"></script>
    <script src="/hkshop/newsf/public/static/admin/js/respond.min.js"></script>
    <![endif]-->
