<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"./application/admin/template/ad_position\edit.htm";i:1718265302;s:69:"D:\wamp\www\hkshop\newsf\application\admin\template\public\layout.htm";i:1711350610;s:72:"D:\wamp\www\hkshop\newsf\application\admin\template\public\theme_css.htm";i:1718265302;s:69:"D:\wamp\www\hkshop\newsf\application\admin\template\public\footer.htm";i:1680168736;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
                                        ...
                                        <?php if(is_array($ad_data) || $ad_data instanceof \think\Collection || $ad_data instanceof \think\Paginator): $k = 0; $__LIST__ = $ad_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if($vo['media_type'] == '1'): ?>
                                                <div class="images_upload">
                                                    <div class="ic">
                                                        ...
                                                        <div class="load_input" id="<?php echo $vo['id']; ?>_ShowInput" data-showOrHide="hide">
            ...
            <dl class="row 1615775137_dl" style="display: none;" id="1615775137_2" style="z-index: 2">
                ...
                <dd class="opt">
                    ...
                    <?php endif; if($WeappOpen['aws_open'] == '1'): ?>
...
<script type="text/javascript">
    ...
    function upload_video_litpic_qiniu(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/hkshop/newsf/index.php?m=plugins&c=Qiniuyun&a=qiniu_upload',
            data: {_ajax: 1},
            dataType: "JSON",
    ...
    function upload_video_litpic_oss(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/hkshop/newsf/index.php?m=plugins&c=AliyunOss&a=oss_upload',
            data: {_ajax: 1},
            dataType: "JSON",
            success: function(res1){
                if (1 == res1.code){
    ...
    function upload_video_litpic_cos(e) {
        ...
        $.ajax({
            type: 'post',
            url: '/hkshop/newsf/index.php?m=plugins&c=Cos&a=cos_upload&_ajax=1',
            data: formData,
            contentType: false,
            processData: false,
            dataType: 'json',
    ...
    function upload_video_litpic_aws(e) {
        ...
        $.ajax({
            type: 'post',
            url: '/hkshop/newsf/index.php?m=plugins&c=Aws&a=aws_upload&_ajax=1',
            data: formData,
            contentType: false,
            processData: false,
            dataType: 'json',
