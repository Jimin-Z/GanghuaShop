...
//使用title内容作为tooltip提示文字
    ...
    $('.sub-menu').on('click','a',function(){
          console.log('line 30 admincp.js');
...
function openItem(param, menu_id, click, click_url) {
      console.log('line 47 admincp.js');
      console.log(param);
...
{
    console.log('line 115 admincp.js');
    console.log('url=='+url+' , '+width+' , '+model);
